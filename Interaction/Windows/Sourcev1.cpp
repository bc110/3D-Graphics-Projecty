...
void startup()
{
	...
	content2.LoadGLTF("assets/dog.gltf");
...
void render()
{
	...
	vec3 lightDisp = vec3(1.0f,1.0f,4.0f);
	...
	content2.DrawModel(content.vaoAndEbos, content.model);

	glm::mat4 modelMatrix2 = glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, 1.0f, 1.0f));
	...
	modelMatrix2 = glm::scale(modelMatrix2, glm::vec3(1.2f, 1.2f, 1.2f));
	glUniformMatrix4fv(glGetUniformLocation(pipeline.pipe.program, "model_matrix"), 1, GL_FALSE, &modelMatrix2[0][0]);
	content2.DrawModel(content.vaoAndEbos, content.model);

	modelMatrix2 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 1.0f, 1.0f));
	modelMatrix2 = glm::rotate(modelMatrix2, modelRotation.x, glm::vec3(1.0f, 0.0f, 0.0f));
	modelMatrix2 = glm::rotate(modelMatrix2, modelRotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
	modelMatrix2 = glm::scale(modelMatrix2, glm::vec3(1.2f, 1.2f, 1.2f));
	glUniformMatrix4fv(glGetUniformLocation(pipeline.pipe.program, "model_matrix"), 1, GL_FALSE, &modelMatrix2[0][0]);
	...
	//drawObject(content,vec3(0.0f, 1.0f, 1.0f),vec3(0.0f, 0.0f, 0.0f),vec3(1.2f,1.2f,1.2f));
}
